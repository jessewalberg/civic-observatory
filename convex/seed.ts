...
const SAMPLE_MUNICIPALITIES = [
  ...
  },
  {
    ...
    meetingsPageUrl: "https://denvergov.org/Government/Agencies-Departments-Offices/City-Council",
  ...
  },
  {
    ...
    meetingsPageUrl: "https://ashevillenc.gov/department/city-clerk/city-council-meetings",
    platform: "civicplus" as const,
    isActive: true,
    isVerified: true,
  },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["housing crisis", "small business impact", "homeless services", "transit reliability"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
        { title: "Police Staffing Plan Review", expectedDate: "Next meeting" },
        { title: "Affordable Housing Bond Measure", expectedDate: "March ballot discussion" },
      ],
      topics: ["budget", "housing", "transportation", "safety", "zoning", "environment"],
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["school closures", "equity concerns", "teacher compensation", "community loss"],
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["transit expansion", "housing affordability", "STR impacts", "police funding"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
        { title: "City Land Inventory Report", expectedDate: "90 days" },
        { title: "Transportation Bond Campaign Launch", expectedDate: "August" },
      ],
      topics: ["transportation", "housing", "budget", "infrastructure", "zoning", "safety"],
      sentiment: "contentious" as const,
    },
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["environmental protection", "density concerns", "housing need", "traffic"],
        sentiment: "negative" as const,
      },
      upcomingItems: [
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["facility needs", "teacher support", "property taxes", "student achievement"],
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["affordability trade-offs", "climate urgency", "downtown revitalization"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
        { title: "Affordability Implementation Rules", expectedDate: "60 days" },
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["school safety", "racial equity", "policing in schools", "boundary impacts"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["artist displacement", "neighborhood character", "historic preservation"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["social housing", "homelessness response", "clean energy", "economic concerns"],
        sentiment: "positive" as const,
      },
      upcomingItems: [
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["school closures", "curriculum diversity", "administrative leadership"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["neighborhood character", "LGBTQ+ community", "design quality"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["homelessness policy", "housing supply", "neighborhood livability", "civil rights"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["police reform", "housing affordability", "environmental justice", "public safety"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
        { title: "Public Safety Director Appointment", expectedDate: "March" },
        { title: "Rent Stabilization Implementation Rules", expectedDate: "90 days" },
      ],
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["housing production", "historic preservation", "transit-oriented development"],
        sentiment: "positive" as const,
      },
      upcomingItems: [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["racial justice", "environmental sustainability", "tourism impacts", "affordability"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["neighborhood character", "parking concerns", "affordable housing"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["housing crisis", "climate action", "downtown vitality", "small business"],
        sentiment: "positive" as const,
      },
      upcomingItems: [
      ...
      topics: ["housing", "budget", "environment", "infrastructure", "transportation"],
      sentiment: "routine" as const,
    },
  },
  {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["tourism vs. housing", "flooding", "climate resilience", "mobility"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
      ...
      topics: ["housing", "zoning", "infrastructure", "budget", "environment", "transportation"],
      sentiment: "routine" as const,
    },
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["industrial impacts", "flood risk", "historic preservation", "job creation"],
        sentiment: "positive" as const,
      },
      upcomingItems: [
        { title: "Council Vote on Wilshire Estates", expectedDate: "February 15" },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["housing affordability", "neighborhood character", "climate action", "open space"],
        sentiment: "mixed" as const,
      },
      upcomingItems: [
  ...
  },
  {
    ...
    summary: {
      ...
      publicComments: {
        ...
        themes: ["parking management", "transit orientation", "pedestrian character"],
        sentiment: "positive" as const,
      },
      upcomingItems: [
        { title: "Council Vote on Transit Village", expectedDate: "February 6" },
...
export const seedMeetings = mutation({
  ...
  handler: async (ctx) => {
    ...
    return {
      message: "Use seedMeetingsBatch1, seedMeetingsBatch2, seedMeetingsBatch3 separately to avoid timeout",
...
export const seedAll = mutation({
  ...
  handler: async (ctx) => {
    ...
    return {
      ...
      message: existingMeetings.length > 0
