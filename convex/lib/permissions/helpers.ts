...
export function hasPermission(userRole: Role | undefined, requiredRole: Role): boolean {
...
export function hasUnlimitedAccess(role: Role | undefined, tier?: string): boolean {
