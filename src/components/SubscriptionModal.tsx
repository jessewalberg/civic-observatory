...
const ALERT_FREQUENCIES = [
  { value: 'immediate', label: 'Immediate', description: 'Get notified as soon as summaries are ready' },
  { value: 'daily', label: 'Daily Digest', description: 'Once per day at 8am' },
  { value: 'weekly', label: 'Weekly Digest', description: 'Once per week on Mondays' },
] as const
...
export function SubscriptionModal({
  ...
  // Mutations
  const createSubscription = useMutation(api.functions.subscriptions.mutations.create)
  const updateSubscription = useMutation(api.functions.subscriptions.mutations.update)
    ...
    try {
      if (existingSubscription) {
        await updateSubscription({
          ...
          meetingTypes: selectedMeetingTypes.length > 0 ? selectedMeetingTypes : undefined,
          alertFrequency,
          emailEnabled,
        })
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) => setAlertFrequency(value as typeof alertFrequency)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
                  ...
                  >
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-muted-foreground">
                        {freq.description}
                        {freq.value === 'immediate' && !canUseImmediate && ' (Pro only)'}
                      </span>
                    </div>
                  </SelectItem>
                ))}
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Only get alerts for specific meeting types, or leave empty for all.
            </p>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Filter alerts by topics of interest, or leave empty for all topics.
            </p>
            <div className="grid grid-cols-2 gap-2">
