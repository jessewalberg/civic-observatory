...
export const Route = createFileRoute('/dashboard/')({
  ...
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Your personalized feed of local government updates' },
    ],
  }),
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
            ...
            <span>{item.municipality.name}, {item.municipality.state}</span>
            <span className="text-border">|</span>
            <span>{meetingTypeLabels[item.meeting.meetingType] ?? item.meeting.meetingType}</span>
          </div>
