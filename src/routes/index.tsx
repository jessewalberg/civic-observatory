...
const audiences = [
  {
    icon: Newspaper,
    title: 'Journalists',
    description: 'Get accurate, citable summaries without sitting through hours of meetings.',
    color: 'text-blue-400',
  },
  {
    icon: Users,
    title: 'Community Activists',
    description: 'Track issues you care about across multiple municipalities and boards.',
    color: 'text-emerald-400',
  },
  {
    icon: Building2,
    title: 'Local Businesses',
    description: 'Stay ahead of zoning changes, permits, and regulations affecting your area.',
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  Most people miss them. With Civic Pulse, you won't. Get AI-powered summaries of
                  city councils, school boards, and planning commissions—delivered to your inbox.
                </motion.p>
              </div>
                  ...
                  {recentMeetings.slice(0, 3).map((meeting, index) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <CompactVoteDisplay yea={meeting.vote.yea} nay={meeting.vote.nay} />
                      </div>
                      <div className="flex gap-2 flex-wrap">
                        {meeting.topics.slice(0, 2).map((topic) => (
                          <TopicBadge key={topic} topic={topic} className="text-xs py-0.5" />
                        ))}
                      </div>
                    </motion.div>
                  ))}
        ...
        <section className="border-t border-border/50 bg-muted/30">
          <div className="mx-auto max-w-7xl px-6 py-24">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-semibold mb-4">Recent Meeting Summaries</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                From coast to coast, local governments are making decisions that affect your daily
                life. Here's what you might have missed.
              </p>
            </motion.div>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {meeting.topics.map((topic) => (
                          <TopicBadge key={topic} topic={topic} className="text-xs py-0" />
                        ))}
                      </div>
                      <CompactVoteDisplay yea={meeting.vote.yea} nay={meeting.vote.nay} />
                    </CardContent>
        ...
        <section className="mx-auto max-w-7xl px-6 py-24">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-semibold mb-4">
              From boring to <span className="text-primary">briefed</span> in three steps
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              No more skimming 200-page agendas or watching 4-hour recordings. Get straight to what
              matters.
            </p>
          </motion.div>
        ...
        <section className="border-t border-border/50 bg-gradient-to-b from-muted/30 to-background">
          <div className="mx-auto max-w-7xl px-6 py-24">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Whether you're covering city hall or just trying to understand why your street got
                repaved, Civic Pulse has you covered.
              </p>
            </motion.div>
            ...
            <div className="relative px-8 py-16 md:px-16 md:py-20 text-center">
              ...
              >
                <h2 className="text-3xl md:text-5xl font-semibold mb-6">
                  ...
                  <br />
                  <span className="text-primary">Are you paying attention?</span>
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                  Join thousands of informed citizens who never miss an important vote, zoning
                  change, or budget decision in their community.
                </p>
