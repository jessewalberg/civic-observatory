...
export const Route = createFileRoute('/explore/$municipalityId')({
  ...
  loader: async ({ params }) => {
    ...
    try {
      ...
      const municipality = await convex.query(api.functions.municipalities.queries.get, {
  ...
  head: ({ loaderData }) => {
    ...
    if (!municipality) {
      return {
        meta: [
          { title: 'Municipality Not Found | Civic Pulse' },
        ],
      }
    }
    ...
    const jsonLd = {
      ...
      address: {
        ...
        addressCountry: 'US',
        ...(municipality.county && { addressRegion: `${municipality.county}, ${municipality.state}` }),
      },
    ...
    return {
      meta: [
        ...
        // Open Graph
        { property: 'og:title', content: `${municipality.name} Municipal Meetings` },
        { property: 'og:description', content: description },
        { property: 'og:type', content: 'website' },
        { property: 'og:site_name', content: 'Civic Pulse' },
        // Twitter Card
        { name: 'twitter:card', content: 'summary' },
        { name: 'twitter:title', content: `${municipality.name} Municipal Meetings` },
...
function MunicipalityDetailPage() {
  ...
  const meetingTypes = useQuery(
    ...
    municipality ? { municipalityId: municipalityId as Id<'municipalities'> } : 'skip'
  )
  ...
  const meetingsData = useQuery(
    ...
    municipality
      ? {
          ...
          meetingType: meetingType && meetingType !== 'all'
